...
class Settings(BaseSettings):
    ...
    github_ref_name: str = os.environ.get("GITHUB_REF_NAME", None)
    github_sha: str = os.environ.get("GITHUB_SHA", None)
    github_repository: str = os.environ.get("GITHUB_REPOSITORY", None)
    github_repo_name = github_repository.split("/")[-1]
    github_actor: str = os.environ.get("GITHUB_ACTOR", None)
    ...
    iam_role: str = os.environ.get("SAGEMAKER_IAM_ROLE", None)
