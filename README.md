...
# mnist-sagemaker-ci-cd

The intent of this repository is to define CI/CD workflows for Sagemaker to train a model then deploy it using FASTAPI on App Runner. 

## Using

_Python package_: to add and install this package as a dependency of your project, run `poetry add mnist-sagemaker-ci-cd`.
